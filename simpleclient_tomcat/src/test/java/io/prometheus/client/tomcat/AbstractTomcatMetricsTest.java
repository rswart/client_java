...
public abstract class AbstractTomcatMetricsTest {
    ...
    //    resource.setProperty("jdbcInterceptors", "io.prometheus.client.tomcat.TomcatJdbcInterceptor(logFailed=true,logSlow=true,threshold=0,buckets=0.01|.05|.1|1|10,slowQueryBuckets=1|10|30)");
        resource.setProperty("jdbcInterceptors", "io.prometheus.client.tomcat.TomcatJdbcInterceptor(logFailed=true,logSlow=true,threshold=0,buckets=.01|.05|.1|1|10,slowQueryBuckets=1|10|30)");
